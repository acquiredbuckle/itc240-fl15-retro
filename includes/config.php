...
define('VIRTUAL_PATH', 'http://www.mitchlthompson.com/itc240/retrodine/'); # Virtual (web) 'root' of application for images, JS & CSS files

define('PHYSICAL_PATH', '/home/mittho2/mitchlthompson.com/itc240/retrodine/'); # Physical (PHP) 'root' of application for file & upload reference
...
//here are our nav pages
$nav1['index.php'] = 'Home';
$nav1['template.php'] = 'Template';
$nav1['daily.php'] = 'Daily';
$nav1['movie_list.php'] = 'Movies';
...
function makeLinks($arr, $prefix='', $suffix='', $exception='')
{
    ...
    {
        if(THIS_PAGE == $link){//current file gets active class
