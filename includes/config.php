...
define('PREFIX', 'retrodine_'); #Adds uniqueness to your DB table names.  Limits hackability, naming collisions
...
*/
define('VIRTUAL_PATH', 'http://www.mitchlthompson.com/itc240/retrodine/'); 
